...
- Lessons and shared documents are designed using examples from [Mozilla Open Leaders Programme](https://foundation.mozilla.org/en/initiatives/mozilla-open-leaders/)
...
For each session, I recommend using roll call with icebreaker questions prompting reflections related to the content.
Below is a suggestion for each session:
...
- Session 4 icebreaker question: From the [LIST OF PERSONAL CORE VALUES](https://thehappinessplanner.co.uk/pages/list-of-core-values), select and share three values based on your current work (this may change in the future)
